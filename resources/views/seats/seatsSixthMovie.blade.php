...
@if(App\Models\SeatsSixthMovie::find($item))
...
<form  method="post" action="{{ route('sixthMovie.destroy',  $item) }}">
        ...
        <form  method="post" action="/sixthMovie/sixthMovie">
...
@if(App\Models\SeatsSixthMovie::find($item + 20))
        <form method="post" action="{{ route('sixthMovie.destroy', $item + 20)}}">
        @csrf
        @method('delete')
...
@if(App\Models\SeatsSixthMovie::find($item + 40))
        <form method="post" action="{{ route('sixthMovie.destroy', $item + 40) }}">
        @csrf
        @method('delete')
...
@if(App\Models\SeatsSixthMovie::find($item + 60))
        <form method="post" action="{{ route('sixthMovie.destroy', $item + 60) }}">
        @csrf
        @method('delete')
