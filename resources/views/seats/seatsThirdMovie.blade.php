...
@if(App\Models\SeatsThirdMovie::find($item))

<form  method="post" action="{{ route('thirdMovie.destroy',  $item) }}">
        ...
        <form  method="post" action="/thirdMovie/thirdMovie">
...
@foreach (range(1, 14) as $item)
        @if(App\Models\SeatsThirdMovie::find($item + 20))
        <form method="post" action="{{ route('thirdMovie.destroy', $item + 20)}}">
        @csrf
        @method('delete')
...
@foreach (range(1, 14) as $item)
        ...
        @if(App\Models\SeatsThirdMovie::find($item + 40))
        <form method="post" action="{{ route('thirdMovie.destroy', $item + 40) }}">
        @csrf
        @method('delete')
...
@foreach (range(1, 14) as $item)
        ...
        @if(App\Models\SeatsThirdMovie::find($item + 60))
        <form method="post" action="{{ route('thirdMovie.destroy', $item + 60) }}">
        @csrf
        @method('delete')
