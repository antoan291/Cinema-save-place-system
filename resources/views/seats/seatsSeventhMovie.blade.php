...
<form  method="post" action="{{ route('seventhMovie.destroy',  $item) }}">
        ...
        <form  method="post" action="/seventhMovie/seventhMovie">
...
@if(App\Models\SeatsSeventhMovie::find($item + 20))
        <form method="post" action="{{ route('seventhMovie.destroy', $item + 20)}}">
        @csrf
        @method('delete')
...
@if(App\Models\SeatsSeventhMovie::find($item + 40))
        <form method="post" action="{{ route('seventhMovie.destroy', $item + 40) }}">
        @csrf
        @method('delete')
...
@if(App\Models\SeatsSeventhMovie::find($item + 60))
        <form method="post" action="{{ route('seventhMovie.destroy', $item + 60) }}">
        @csrf
        @method('delete')
