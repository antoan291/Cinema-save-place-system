...
class SeatsSecondMovieController extends Controller
{
    /**
    ...
    public function index(SeatsSecondMovie $seats)
    {
        

       return view('seats.seatsSecondMovie',compact('seats'));
    }
    ...
    {
        $seats = SeatsSecondMovie::find($id);
