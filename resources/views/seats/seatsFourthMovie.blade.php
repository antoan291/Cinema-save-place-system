...
@if(App\Models\SeatsFourthMovie::find($item))

<form  method="post" action="{{ route('fourthMovie.destroy',  $item) }}">
        ...
        <form  method="post" action="/fourthMovie/fourthMovie">
...
@foreach (range(1, 14) as $item)
        @if(App\Models\SeatsFourthMovie::find($item + 20))
        <form method="post" action="{{ route('fourthMovie.destroy', $item + 20)}}">
        @csrf
        @method('delete')
...
@foreach (range(1, 14) as $item)
        ...
        @if(App\Models\SeatsFourthMovie::find($item + 40))
        <form method="post" action="{{ route('fourthMovie.destroy', $item + 40) }}">
        @csrf
        @method('delete')
...
@foreach (range(1, 14) as $item)
        ...
        @if(App\Models\SeatsFourthMovie::find($item + 60))
        <form method="post" action="{{ route('fourthMovie.destroy', $item + 60) }}">
        @csrf
        @method('delete')
