...
@if(App\Models\SeatsFifthMovie::find($item))

<form method="post" action="{{ route('fifthMovie.destroy',  $item) }}">
        ...
        <form  method="post" action="/fifthMovie/fifthMovie">
...
@foreach (range(1, 14) as $item)
        @if(App\Models\SeatsFifthMovie::find($item + 20))
        <form method="post" action="{{ route('fifthMovie.destroy', $item + 20)}}">
        @csrf
        @method('delete')
...
@foreach (range(1, 14) as $item)
        ...
        @if(App\Models\SeatsFifthMovie::find($item + 40))
        <form method="post" action="{{ route('fifthMovie.destroy', $item + 40) }}">
        @csrf
        @method('delete')
...
@foreach (range(1, 14) as $item)
        ...
        @if(App\Models\SeatsFifthMovie::find($item + 60))
        <form method="post" action="{{ route('fifthMovie.destroy', $item + 60) }}">
        @csrf
        @method('delete')
